...
import { UdefinedComponent } from './components/udefined/udefined.component';
...
export const routes: Routes = [
  ...
  // admin routes
  {
    ...
    children: [
      ...
      { path: 'login', title: 'Dashboard', component: AdminLoginComponent },
      { path: 'add-user', title: 'Add User', component: AddUserComponent },
      { path: 'edit-user', title: 'Edit User', component: EditUserComponent },
    ],
  },

  // undefined routes 
  { path: '**', component: UdefinedComponent },
];
